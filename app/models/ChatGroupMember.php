...
class ChatGroupMember extends Model {
    ...
    function getChatGroupMembers($group_id) {
        ...
        return $this->query('SELECT * FROM chat_group_members WHERE group_id=:group_id ORDER BY id ASC',
        array(':group_id'=>$group_id));
    }
    ...
    function getChatGroupMember($user_id, $group_id) {
        
        if($this->query('SELECT * FROM chat_group_members WHERE user_id=:user_id AND group_id=:group_id ', array(':user_id'=>$user_id, ':group_id'=>$group_id))) {

            return $this->query('SELECT * FROM chat_group_members WHERE user_id=:user_id AND group_id=:group_id ',
